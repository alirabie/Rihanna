...
import rihanna.appsmatic.com.rihanna.Adabtors.ExpertDiscountedServicesAdb;
...
public class LatestOffersFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_latest_offers, container, false);
    }
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        emptyFlag=(TextView)view.findViewById(R.id.frag_latest_offers_emptylist_flag);
                    ...
                    if (response.body().getServices() != null) {
                        if (response.body().getServices().isEmpty()) {
                            ...
                            if (services.isEmpty()) {
                                ...
                                emptyFlag.setVisibility(View.INVISIBLE);
                                servicesList = (RecyclerView) view.findViewById(R.id.frag_latest_offers_list);
                                servicesList.setAdapter(new ExpertDiscountedServicesAdb(getContext(), services, LatestOffersFrag.this));
